...
#define DEFAULT_TIME_OPTIONS_INI        "1500,600,300"
...
#endif
#define MAX_POMODORO_OPTION_SECONDS     MAX_TIME_OPTION_SECONDS
#define POMODORO_OPTIONS_CONFIG_BUFFER_SIZE 512
...
#define MAX_NOTIFICATION_FONT_SIZE      100
